...
# Выгрузка бинарного файла :: код располагается в $9000, данные в $0x200000
if (ld -m elf_i386 -nostdlib -nodefaultlibs --oformat binary -Ttext=0x9000 -Tdata=0x100000 startup.o kernel.o -o kernel.c.bin)
then
